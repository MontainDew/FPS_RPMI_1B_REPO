...
public class FP_Controller : MonoBehaviour
{
    ...
    [SerializeField] float speed = 3f; // M�s lento para terror
    ...
    public bool isCrounching; // Hecho p�blico para que el enemigo lo lea

    [Header("Horror Mechanics")]
    [SerializeField] Light flashlight; // Linterna
    [SerializeField] float standingHeight = 0.6f; // Altura normal de la c�mara
    [SerializeField] float crouchingHeight = -0.2f; // Altura de la c�mara al agacharse
    ...
    [SerializeField] float crouchVolume = 0.15f; // M�s silencioso al agacharse
    ...
    void Jump()
    {
        if (isGrounded && !isCrounching) // No saltar si est� agachado
